...
export default {
  ...
  "blueprint.starter_connect_openai_title": "Connect ATRouter",
  "blueprint.starter_connect_openai_desc": "Add your ATRouter provider to access GLM, DeepSeek, MiniMax and more.",
